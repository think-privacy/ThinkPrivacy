...
The answer actually lies in one’s [threat model](https://ssd.eff.org/en/glossary/threat-model), which is often an ignored step in choosing all privacy related apps and services, meaning a lot of users limit their internet and communication experience because they believe they need Edward Snowden level privacy settings.
...
If your goal is to simply avoid corporate tracking and the harvesting of your data from your communications, you can eliminate apps such as Facebook Messenger and WhatsApp, both services owned by Facebook and while offering encrypted messaging (optional in Messenger), [Facebook reads your non-encrypted messages](https://www.digitaltrends.com/social-media/facebook-reads-messenger-messages/), and WhatsApp [has fallen victim to security breaches](https://www.forbes.com/sites/zakdoffman/2019/05/14/whatsapps-cybersecurity-breach-phones-hit-with-israeli-spyware-over-voice-calls/#734cec155549).
...
When it comes to avoiding corporate data mining, your metadata won’t be as useful, especially if you’re using a service that is not profiting from your data to begin with. For those avoiding state-sponsored surveillance, [metadata can be a killer](https://theintercept.com/2019/08/04/whistleblowers-surveillance-fbi-trump/).

# Encryption

This article will not get into the complexities of the best kinds of [end-to-end encryption](https://ssd.eff.org/en/glossary/end-end-encryption) (E2EE), but ensuring your messenger has it, that must be discussed.
...
In an interview with [Gizmodo](https://gizmodo.com/why-you-should-stop-using-telegram-right-now-1782557415), Christopher Soghoian, Principal Technologist and Senior Policy Analyst at the American Civil Liberties Union said that, "There are many Telegram users who think they are communicating in an [end-to-end] encrypted way, when they’re not because they don’t realize that they have to turn on an additional setting,” he continued to say that while he’s happy they offer the encryption, it’s not useful if it’s turned off.

Apps such as Signal, Keybase, and Wickr offer E2EE by default. Less popular but quickly growing apps such as Riot, offer E2EE but like Telegram, have not made it a default setting, though Riot has said that default encryption is on their road map.
...
Wire [recently lost a great deal of trust and standing](https://blog.privacytools.io/delisting-wire/) in the privacy world because they quietly sold their company and moved it to the US. They also changed parts of their privacy policy making it harder for users to tell when Wire would share customer data. They did all of this while never updating their current users of such changes, either to the change of the privacy policy, or the move to the US.
...
Matrix.org (the service Riot uses) runs a similar business model as Signal, located in the UK instead of the US, they reply on donations, partnerships, and grants. Matrix.org is heavily supported by New Vector, a venture capital backed company, however, Matrix.org as a non-profit is transparent about its spending, income, and influences.
...
This article was originally published to [Hacker Noon](https://hackernoon.com/choosing-the-right-messenger-mm3x2z47) on November 27th, 2019.
